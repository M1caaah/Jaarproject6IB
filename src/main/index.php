        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <li class="scroll-to-section"><a href="#projects">Bestsellers</a></li>
              <li class="has-sub">
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="section-heading">
            <h2>Discover Our <em>Bestsellers</em></h2>
            <div class="line-dec"></div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-6 offset-lg-6">
          <div class="row">
            <div class="col-lg-12">
              <div class="section-heading">
                <h2>We Provide <em>Cheap games</em> &amp;
                  <span>Software</span> For all your needs
                </h2>
                <div class="line-dec"></div>
              </div>
            </div>
          ...
          <div class="contact-us-content">
            <div class="row">
              <div class="col-lg-4">
                <div id="map">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d10034.487013914655!2d3.7183767!3d51.0416064!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47c3715eaf4d34f7%3A0x5abd16b1ac391a5e!2sGO*21%20Lyceum%20Ghent!5e0!3m2!1sen!2sbe!4v1701626827057!5m2!1sen!2sbe"
                  ...
                  <div class="row">
                    <div class="col-lg-4">
                      <div class="info-item">
                        ...
                        <h4><a href="#">+32 479 05 77 58</a></h4>
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="info-item">
                        <i class="fa fa-envelope"></i>
                        <h4><a href="#">bothamicah@lyceumgent.be</a></h4>
                        <h4><a href="#">verheyenobi@lyceumgent.be</a></h4>
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="info-item">
                        <i class="fa fa-map-marker"></i>
                        <h4><a href="#">Kortrijksesteenweg 12, 9000 Gent</a></h4>
                      </div>
                    </div>
                  </div>
                </div>
